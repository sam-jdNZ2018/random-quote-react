...
class QuoteMachine extends React.Component {
  ...
  render() {
    ...
    return (
      React.createElement("div", { id: "quote-outer" },
      React.createElement("h1", { id: "title" }, "The Quote Machine"),
      React.createElement("div", { id: "quote-box" },
      React.createElement("div", { id: "quote-cont" },
      React.createElement("div", { id: "quote-details" },
      React.createElement("p", { id: "text" },
      React.createElement("i", { className: "fas fa-quote-left" }), " ", this.state.qtext),

      React.createElement("p", { id: "author" }, this.state.qauth)),

      React.createElement("div", { id: "button-cont" },
      React.createElement("div", { id: "social-cont" },
      React.createElement("a", { className: "btn btn-default", id: "tweet-quote", style: color, href: twink, target: "_blank", type: "button" },
      React.createElement("i", { className: "fab fa-twitter" })),

      React.createElement("a", { className: "btn btn-default", id: "tumble-quote", style: color, href: tulink, target: "_blank", type: "button" },
      React.createElement("i", { className: "fab fa-tumblr" }))),


      React.createElement("button", { className: "btn btn-default", id: "new-quote", type: "button", style: color, onClick: this.replaceCurrQuote }, "Get New Quote"))))));
...
ReactDOM.render(React.createElement(QuoteMachine, null), document.getElementById("main"));